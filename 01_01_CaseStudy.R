### The following is a case study that I performed in a LinkedIn Learning course I worked on summer 2021
## I cannot take credit for the coding, this should simply serve as an example of some processes I have used
# - AC
...
# Import Big 5 data
df <- import("C:/Users/alanc/Desktop/Ex_Files_R_EssT_Modeling_Data/Exercise Files/data/b5_df.rds") %>%
  print()
